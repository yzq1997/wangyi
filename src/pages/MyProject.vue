			...
			<div :style="{width:+collapsed?'80px':'260px',float:'left',transition:'all 0.4 linear'}">
				<div class="headerOprtionLeft" style="height: 70px;">
				    <div class="logo" :style="{width:+collapsed?'80px':'260px'}">
				        ...
				        <span v-if="collapsed==false" style="line-height: 70px; padding-left: 24px;">315投诉平台</span>
				    </div>
				</div>
				<a-menu
...
import GroupComplaints from './Module/GroupComplaints';
import BrandComplaints from './Module/BrandComplaints';
import Brand from './Module/Brand';
import SourceManagement from './SystemSettings/SourceManagement';
import UserManagement from './SystemSettings/UserManagement';
